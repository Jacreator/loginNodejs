...
module.exports = {
    signUp: async (req, res) => {
        ...
        if (foundUser) {
            ...
            res.status(200).json({ success: "user merged" });
        }
    ...
    signIn: async (req, res) => {
        // Generate token
        "use strict"; const token = signToken(req.user);
        res.cookie('access_token', token, {
            httpOnly: true
        });
    ...
    signOut: async (req, res) => {
        "use strict"; res.clearCookie('access_token');
    ...
    unlinkFacebook: async (req, res) => {
        ...
        "use strict"; if (req.user.facebook) {
    ...
    dashboard: async (req, res) => {
        "use strict"; console.log('I managed to get here!');
        res.json({
            secret: "resource",
            methods: req.user.methods
        });
